...
public class UI implements ActionListener {
    ...
    private final JButton but[], butAdd, butMinus, butMultiply, butDivide,
            ...
            butCos, butSin, butTan, butxpowerofy, butlog, butrate, butabs, butBinary, butpi, butCube, butmi, butBack;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(source == butmi){
             writer(calc.calculateMono(Calculator.MonoOperatorModes.mi, reader()));
         }
        if (source == butBack) {
            int value = (int)reader();
            writer(calc.back(value));
        } 
        text.selectAll();
    }
